# kowalski-academic-agent AI Agent Documentation

> **READ THIS FIRST**: This file serves as the single source of truth for any AI agent (Claude, Gemini, Cursor, etc.) working on the `kowalski-academic-agent` component of the Kowalski repository. It aggregates architectural context, development workflows, and behavioral guidelines.
...
**Name**: kowalski-academic-agent  
**Purpose**: Specialized agent for academic research and PDF analysis.  
...
**Target Users**: Kowalski framework agents and developers integrating kowalski-academic-agent.  
