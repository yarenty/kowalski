...
pub enum Commands {
    ...
    Chat {
        ...
        message: String,
        /// Model to use
        #[arg(short, long, default_value = "llama2", help = "The AI model to use for the conversation")]
        model: String,
    },
    ...
    Academic {
        ...
        file: PathBuf,
        /// Model to use
        #[arg(short, long, default_value = "llama2", help = "The AI model to use for analysis")]
        model: String,
        /// Output format
        #[arg(short, long, default_value = "text", help = "Output format (text, json, or markdown)")]
        format: String,
    },
    /// Manage AI models
    /// 
...
pub enum ToolCommands {
    ...
    Search {
        ...
        query: String,
        /// Model to use
        #[arg(short, long, default_value = "llama2", help = "The AI model to use for processing results")]
        model: String,
        /// Number of results to return
        #[arg(short, long, default_value = "5", help = "Maximum number of search results to process")]
        limit: usize,
    },
    ...
    Scrape {
        ...
        url: String,
        /// Model to use
        #[arg(short, long, default_value = "llama2", help = "The AI model to use for content analysis")]
        model: String,
        /// Whether to follow links
        #[arg(short, long, default_value = "false", help = "Whether to follow and analyze linked pages")]
        follow_links: bool,
        /// Maximum depth for link following
        #[arg(short, long, default_value = "1", help = "Maximum number of link hops to follow")]
        max_depth: u32,
    },
    /// Analyze code
    /// 
    ...
    Code {
        ...
        path: PathBuf,
        /// Model to use
        #[arg(short, long, default_value = "llama2", help = "The AI model to use for code analysis")]
        model: String,
        /// Language of the code
        #[arg(short, long, help = "Programming language of the code (optional, will be auto-detected if not specified)")]
