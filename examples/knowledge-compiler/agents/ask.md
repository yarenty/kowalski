...
output = "debug/reports/latest.md"
---
...
When delegated `kc.ask`, the worker reads the wiki index, formulates a grounded answer to the user question, and emits a markdown report under `debug/reports/`.
