# kowalski-tools AI Agent Documentation

> **READ THIS FIRST**: This file serves as the single source of truth for any AI agent (Claude, Gemini, Cursor, etc.) working on the `kowalski-tools` component of the Kowalski repository. It aggregates architectural context, development workflows, and behavioral guidelines.
...
**Name**: kowalski-tools  
**Purpose**: Pluggable tools for code, web, and data analysis.  
...
**Target Users**: Kowalski framework agents and developers integrating kowalski-tools.  
