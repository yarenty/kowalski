...
Crate version **1.5.0** (see `Cargo.toml`). For the whole workspace, see **[`../ROADMAP.md`](../ROADMAP.md)**.

## Near term

- [ ] **Coder execution tier (1.5):** project tree ingest (`source_bundle`), tool-enabled federation stages, conditional edges — see **[`../ROADMAP.md`](../ROADMAP.md)** § *Coder horde — execution tier*.
