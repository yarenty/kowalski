...
**Crate version 1.4.0** (see workspace [`Cargo.toml`](../Cargo.toml)). On crates.io until **1.5.0** publish, depend on **1.3.0** or git.
...
```toml
[dependencies]
kowalski = "1.3.0"   # crates.io today; 1.4.0+ from git until 1.5 publish
