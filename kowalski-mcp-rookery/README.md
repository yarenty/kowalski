...
**Version 1.5.0** — standalone **MCP** server exposing the **Rookery** horde-builder primitives from `kowalski-core`. Runs over **stdio** *or* **stateless Streamable HTTP** (shared [`kowalski-mcp-base`](../kowalski-mcp-base/)).
